  ...
  async function onSubmit(values: ImageFormValues) {
    ...
    try {
      ...
      if (result.error) {
        ...
        toast({ title: "Image Generation Started", description: "Your image is being created.", icon: <Wand2 className="h-5 w-5 text-primary" /> });
        onOpenChange(false); // Close dialog on success
        form.reset();
      }
    } catch (error) {
      toast({ title: "Submission Error", description: "Failed to submit image generation request.", variant: "destructive" });
    } finally {
      setIsLoading(false);
    }
  }
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] bg-card shadow-xl rounded-lg">
        <DialogHeader>
          <DialogTitle className="font-headline text-2xl text-primary">Generate New Image</DialogTitle>
          <DialogDescription>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 p-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select onValueChange={(value) => form.setValue('model', value)} defaultValue={form.getValues('model')}>
            ...
            <div className="space-y-2">
              ...
              <Input id="seed" placeholder="e.g., 42 or random_string" {...form.register("seed")} className="focus:ring-primary" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input id="width" type="number" placeholder="1024" {...form.register("width")} className="focus:ring-primary" />
            ...
            <div className="space-y-2">
              ...
              <Input id="height" type="number" placeholder="1024" {...form.register("height")} className="focus:ring-primary" />
          ...
          <div className="flex items-center space-x-2 pt-2">
            ...
            />
            <Label htmlFor="enhance" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
          ...
          <DialogFooter className="pt-4">
            ...
            <Button type="submit" disabled={isLoading} className="bg-accent hover:bg-accent/90 text-accent-foreground">
              {isLoading ? <LoadingSpinner className="mr-2" size="sm" /> : <Wand2 className="mr-2 h-4 w-4" />}
              Generate Image
            </Button>
          </DialogFooter>
        </form>
